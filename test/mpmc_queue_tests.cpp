...
int main(int /* argc */, char ** /* argv */){
	...
	test_with_concurrency(1, 1, 1.0f, num_items, normal_producer<float>, normal_consumer<float>);

	cout << "Running MPMC tests with small amounts of concurrency.\n";
	cout << "1p2c: " << std::flush;
	test_with_concurrency(1, 2, 1.0f, num_items, normal_producer<float>, normal_consumer<float>);
	cout << "done\n";
	cout << "2p1c: " << std::flush;
	test_with_concurrency(2, 1, 1.0f, num_items, normal_producer<float>, normal_consumer<float>);
	cout << "done\n";
	cout << "2p2c: " << std::flush;
	test_with_concurrency(2, 2, 1.0f, num_items, normal_producer<float>, normal_consumer<float>);
	cout << "done\n";
}
